...
class ROBOT:
    ...
    def send_objects(self, sim):
        ...
        self.O3 = sim.send_cylinder(x=0, y=0-c.L, z=c.L + c.R, length=c.L, radius=c.R, r1=0, r2=1, r3=0, r=0, g=0, b=1)
        self.O4 = sim.send_cylinder(x=0-c.L, y=0, z=c.L + c.R, length=c.L, radius=c.R, r1=1, r2=0, r3=0, r=1, g=0, b=1)
